...
var _get_data = __webpack_require__(27);
  ...
  _createClass(Hello, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_get_data2.default, null)
      );
    }
  }]);
...
var API_URL = 'https://react-list-2c16c.firebaseio.com/';

var GetData = function (_Component) {
    _inherits(GetData, _Component);

    function GetData() {
        _classCallCheck(this, GetData);

        var _this = _possibleConstructorReturn(this, (GetData.__proto__ || Object.getPrototypeOf(GetData)).call(this));
...
var List = function List(props) {
    var listItem = props.items.map(function (item) {
        return _react2.default.createElement(ListItem, { item: item, key: item.id });
    });
